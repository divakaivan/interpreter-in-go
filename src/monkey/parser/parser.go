...
import (
	...
	"github.com/divakaivan/interpreter-in-go/src/monkey/ast"
...
func (p *Parser) ParseProgram() *ast.Program {
	...
	// iterate over every token until EOF
	...
	// when nothing is left to parse, the root node is returned
	return program
}
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: skip exxpression until finding a semicolon
